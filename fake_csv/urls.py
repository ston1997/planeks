...
from .views import SchemeList, CreateSchema, EditSchema, SchemeDetail, delete
...
urlpatterns = [
    ...
    path('edit/<int:pk>/', login_required(EditSchema.as_view()), name='edit'),
    # path('delete/<int:pk>/', login_required(SchemeDelete.as_view()), name='delete'),
